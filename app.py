...
if st.sidebar.button("Run Real-World Backtest"):
    if edited_portfolio.empty or edited_portfolio['Ticker'].isna().any():
        ...
        with st.spinner("Downloading historical prices & valuing portfolio..."):
            ...
            # Keep a raw copy of the prices in their ORIGINAL currency before the math engine converts them
            ...
            for ticker in my_tickers:
                ...
                # Use the raw_prices copy to ensure US stocks display in USD, perfectly matching the original cost basis
            ...
            # Dynamic height scaling ensures all tickers are drawn without being squished or hidden
